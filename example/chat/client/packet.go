...
func NewHeartbeatMessage() *HeartbeatMessage {
	return &HeartbeatMessage{PacketHeader{Type: "heartbeat_message"}}
}
...
func ClientParseBytesToIface(b []byte) (interface{}, MessageType) {
	var header PacketHeader
	if err := json.Unmarshal(b, &header); err != nil {
	...
	case "server_resp_title":
		...
		return t, TypeServerRespTitle
	case "server_recv_message":
		t := &ServerRecvMessage{}
		_ = json.Unmarshal(b, t)
		return t, TypeServerRecvMessage
	case "server_resp_messages":
		t := &ServerRespMessages{}
		_ = json.Unmarshal(b, t)
		return t, TypeServerRespMessages
	case "heartbeat_message":
		t := &HeartbeatMessage{}
		_ = json.Unmarshal(b, t)
		return t, TypeHeartbeatMessage
	default:
		return nil, TypeUnknown
	}
}
